...
echo "50 500 Median stacked profile with error bars" | gmt pstext -R -J -Gwhite -F+jTC+f10p,red -O -K >> $ps
echo "0 -1000 Kuril-Kamchatka Trench" | gmt pstext -R -J -Gwhite -F+jTC+f9p -O -K >> $ps
